"""
Django settings for tutor_smith project.
...
SECRET_KEY = open(os.path.join(BASE_DIR, 'SECRET_KEY.txt')).readline()
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'custom_tags': 'tutor_smith.templatetags.custom_tags',
            },
        },
    },
]

WSGI_APPLICATION = 'tutor_smith.wsgi.application'
